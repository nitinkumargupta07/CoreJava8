...
public class References {
	...
	private void instanceMethodRef() {
		...
		MovieChecker isHorror=movieId ->util.isHorror(movieId);
		
		MovieChecker isHorrer2=ReferenceUtil::isHorror;
		
		Greeting classicName=movieId -> util.isClassicName(movieId);
