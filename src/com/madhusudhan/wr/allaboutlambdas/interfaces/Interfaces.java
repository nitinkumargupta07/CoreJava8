...
public class Interfaces {
	...
	public void testHospitalLambdaExp(Patient patient) {
		generalAdmittance.admit(patient);
		generalAdmittanceMethodRef.admit(patient);
		emergencyAddmittance.admit(patient);
		factory.create(0);
	...
	public static void main(String[] args) {
		...
		interfaces.testHospitalLambdaExp(patient);
