...
public class OptionalType {
	...
	public static void main(String[] args) {
		...
		optionalType.sumOfAttendees();
		optionalType.noAttendeesOptional();
		optionalType.creatingOptionals();
		optionalType.usingIfPresent();
		optionalType.usingOrElse();
		
		try {
			optionalType.usingOrElseThrow();
		} catch (Exception e) {
			System.out.println("Expected exception: ");
			e.printStackTrace();
		}
		
		 optionalType.filteringAndMapping();
	}
