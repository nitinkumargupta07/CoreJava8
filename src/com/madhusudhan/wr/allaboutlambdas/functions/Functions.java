...
public class Functions {
	...
	public void usingAndThenAndCompose2() {
		...
		Integer amount3 = factoredInterest.andThen(factoredInterest).apply(10);
		Integer amount4 = factoredInterest.compose(principalInterest).apply(10);
		
		Integer aamount=principalInterest.apply(10);
		System.out.println("Apply interest first before factoring it:"+aamount);
	...
	public static void main(String[] args) {
		...
		functions.tradeFinder(1);
		functions.tradeFinderJava8(1);
		
		functions.usingAndThenAndCompose();
		
		functions.usingAndThenAndCompose2();
		
		functions.usingIdFunction();
	}
