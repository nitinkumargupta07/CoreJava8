...
public class ParallelStreamsFeature {
	...
	public static void main(String[] args) {
		...
		ParallelStreamsFeature parallelStreamsFeature=new ParallelStreamsFeature();
		List<Movie> classics = parallelStreamsFeature.findClassics(movies);
		classics.forEach(System.out::println);
		List<Movie> classics2 = parallelStreamsFeature.findClassics2(movies);
		classics2.forEach(System.out::println);
	}
}
