package concurrency.com.assignment;

/**
 * AccountRunnable class Created by saba on 2014-10-11.
 */
public class AccountRunnable<T extends BankAccount> implements Runnable {
	...
	public void run() {
		System.out.println(
				threadName + " starting transfer from " + sourceBankAccount.getId() + " to " + destBankAccount.getId());
